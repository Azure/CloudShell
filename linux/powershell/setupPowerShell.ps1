...
try {
    ...
    if ($image -eq "Base") {
        ...
        PowerShellGet\Install-Module -Name Microsoft.PowerShell.SecretManagement -Repository PSGallery -MaximumVersion $script:dockerfileDataObject.SecretManagementMaxVersion @prodAllUsers
        PowerShellGet\Install-Module -Name Microsoft.PowerShell.SecretStore -Repository PSGallery -MaximumVersion $script:dockerfileDataObject.SecretStoreMaxVersion @prodAllUsers
