...
try {
    ...
    if ($image -eq "Base") {
        ...
        PowerShellGet\Install-Module -Name Microsoft.PowerShell.SecretManagement -Repository PSGallery
        PowerShellGet\Install-Module -Name Microsoft.PowerShell.SecretStore -Repository PSGallery
