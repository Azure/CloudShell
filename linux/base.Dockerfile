...
RUN update-alternatives --install /usr/bin/python python /usr/bin/python3.7 1 \
    && update-alternatives --install /usr/bin/pdb pdb /usr/bin/pdb3.7 1 \
    && update-alternatives --install /usr/bin/pygettext pygettext /usr/bin/pygettext3.7 1 \
    && update-alternatives --install /usr/bin/pyclean pyclean /usr/bin/py3clean 1 \
    && update-alternatives --install /usr/bin/pycompile pycompile /usr/bin/py3compile 1 \
    && update-alternatives --install /usr/bin/pydoc pydoc /usr/bin/pydoc3.7 1 \
    && update-alternatives --install /usr/bin/pyversions pyversions /usr/bin/py3versions 1 \
    && update-alternatives --install /usr/bin/python-config python-config /usr/bin/python3-config 1 \
    && update-alternatives --install /usr/bin/x86_64-linux-gnu-python-config x86_64-linux-gnu-python-config /usr/bin/x86_64-linux-gnu-python3.7-config 1
...
RUN chmod 755 /usr/local/bin/ansible* \
    ...
    && /bin/bash -c "source ansible/bin/activate && pip3 install ansible && pip3 install pywinrm>=0.2.2 && pip3 install -r requirements-azure.txt && deactivate" \
